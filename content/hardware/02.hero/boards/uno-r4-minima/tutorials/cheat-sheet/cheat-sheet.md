...
The Arduino® UNO R4 Minima is a development board with the classic UNO form factor, based on the [RA4M1](https://www.renesas.com/us/en/document/dst/renesas-ra4m1-group-datasheet) microcontroller from Renesas microcontroller from [Renesas](https://www.renesas.com/). It now comes with 32 kB of RAM memory, a clock speed of 48 MHz, and a USB-C® port.
