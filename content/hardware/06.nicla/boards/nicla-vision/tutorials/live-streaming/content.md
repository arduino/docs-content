---
title: Video Live Streaming with OpenMV
difficulty: beginner
...
- Learn how to use the Nicla Vision WiFi® connectivity
...
In this section you will learn how the micropython script works in order to capture live video and stream it to your local network.

Application Examples:

- Monitor the progress of 3D printers
- Video surveillance of your house
- Doorbell to monitor the delivery of your packages
...
Click on the "Play" button at the bottom of the left toolbar. Open the IDE Serial Monitor and wait for the board to connect to the internet and display the host address.
...
You can play with the camera resolution by changing it in the `set_framesize` function. For example, the streaming below is in `HD`, as you can notice, this affects the streaming fps.
