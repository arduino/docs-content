...
The complete workspace interface for client Opta™ should resemble the following image if the main PLC code was successfully compiled and uploaded to client Opta™:
