...
* [Portenta X8 Datasheet](https://docs.arduino.cc/static/77d2be9902708fcb73b19d0f1173c6bb/ABX00049-datasheet.pdf)
...
* `nmcli device Wi-Fi connect <SSID> password <PASSWORD>` to connect to a specific SSID
...
* [Create and Upload a Custom Container to the Portenta X8](https://docs.arduino.cc/tutorials/portenta-x8/custom-container)
* [Running Wordpress and Database Containers on the Portenta X8](https://docs.arduino.cc/tutorials/portenta-x8/wordpress-webserver)
