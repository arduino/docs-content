...
***__Note:__ This is an optional step that enables the possibility of performing remote over-the-air updates on your Portenta X8 OS and applications. The Portenta X8 Board Manager is a paid add-on available to Arduino Cloud for Business plans (Team and Enterprise). For pricing details and to get access, please contact our PRO support team using this [form](https://www.arduino.cc/pro/contact-us/).***
...
The Portenta X8 Board Manager is a paid add-on available to Arduino Cloud for Business plans (Team and Enterprise). For pricing details and to get access, please contact our Sales team using this [form](https://www.arduino.cc/pro/contact-us/).
