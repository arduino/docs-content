...
This example for a Yún device shows how to create a basic HTTP client that connects to the internet and downloads content. In this case, you'll connect to the Arduino website and download a version of the logo as ASCII text.
...
<iframe src="https://app.arduino.cc/sketches/examples?nav=Examples&eid=bridge_1_7_0%2FHttpClient&slid=Bridge%401.7.0&view-mode=embed" style="height:510px;width:100%;margin:10px 0" frameBorder="0"></iframe>