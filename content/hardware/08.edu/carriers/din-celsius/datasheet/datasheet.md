...
# Description
The Arduino DIN Celsius offers you a mini temperature laboratory to test your PLC skills, with two independant heater circuits and one temperature sensor placed at the center of the board.
...
## Heating circuits
The board provides two independant heating circuits powered by 24 V trough two different screw connector, one placed on the left side of the temperature sensor and the other on the right side. You can see how it works in the following image:

![heater](assets/Celsius-heater_func.png)

The heat is generated by the current passing trough four resistors in series, and the power is about 120 mW per circuits.
