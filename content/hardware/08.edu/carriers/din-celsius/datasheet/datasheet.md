...
# Description
The Arduino® DIN Celsius offers you a mini temperature laboratory to test your PLC skills, with 2 indipendent heater circuits and 1 temperature sensor placed at the center of the board.
...
- **Heater circuits** 
    - 2 indipendent heater circuits
- **Screw connectors** 
    - 2 screw connectors exposing +24V DC
    - 2 screw connectors exposing GND
    - 2 screw connectors for the 2 indipendent heater circuits (24V)
...
## Heating circuits
The board provides 2 indipendent heating circuits powered by 24V trough two different screw connector, one placed on the left side of the temperature sensor and the other on the right side. You can see how it works in the following image:

![heater](assets/Celsius-heater_func.png)

The heat is generated by the current passing trough four resistors in series, and the power is about 120mW per circuits.

[//]: # (Scaricare il pdf degli schematici e tagliarlo)
...
Here you can see its main characteristc:
 ...
 - 400mV at 0°C
 - accuracy max +-2.5°C 
 - -10°C to 125°C Vdd 3.1V to 5.5V

In order to create an analog output signal (0 - 10V) a 4.9 multiplier circuits it's been added before the OUTPUT VOLTAGE screw connector pin.
