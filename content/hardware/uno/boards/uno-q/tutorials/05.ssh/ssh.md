...
The [Arduino® UNO Q](https://store.arduino.cc/products/uno-q) can be programmed via the [Arduino App Lab](/software/app-lab/), a desktop application supporting code editing and running [Apps](/software/app-lab/getting-started/quickstart/#create--run-apps) on the board without any external tools.
...
\* Read more about the `arduino-app-cli` in the [Arduino App CLI guide](/software/app-lab/cli/cli).
...
- [First setup](/software/app-lab/getting-started/quickstart/#install--set-up-arduino-app-lab) of board completed\*
...
More details on the `arduino-app-cli` tool can be found in the [Arduino App CLI guide](/software/app-lab/cli/cli/).
...
- Has the first setup been completed? If not, follow the instructions [here](/software/app-lab/getting-started/quickstart/#install--set-up-arduino-app-lab) and see the instructions. The first setup will enable SSH on the board, which is required to connect.
