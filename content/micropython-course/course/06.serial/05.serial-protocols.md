...
In this chapter, we learned about the three most common serial protocols in Arduino: **I2C, SPI** and **UART**. We covered the basics of these serial protocols, and introduced an example that connects to a sensor using I2C.
