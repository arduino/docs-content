...
Below is a script that first connects to Wi-Fi, and then downloads a specific module. In this case, we will provide a URL to a file stored on GitHub (the raw file). In this case, we will install the **LIS3DHTR** module, which will be used later on in this course.
...
# example: https://raw.githubusercontent.com/ubidefeo/MicroPython-Classes/main/lib/ahtx0.py
URL = ""
