...
Select, configure, and update your board to prepare it for development in Arduino App Lab. This process ensures your board has the necessary settings, such as network credentials and the latest system updates, to run and deploy Apps effectively.
