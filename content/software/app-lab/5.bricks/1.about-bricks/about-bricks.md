...
| MCP Client | This brick helps you connect to the MCP server and send/receive messages. It provides a simple interface for communication with the MCP server, allowing you to easily integrate it into your Arduino projects. | [GitHub](https://github.com/arduino/app-bricks-py/tree/main/src/arduino/app_bricks/mcp_client) |
...
| Vision Language Model (VLM) | Vision Language Model (VLM) Brick enables seamless integration with locally hosted VLMs for advanced AI capabilities in your Arduino projects. | [GitHub](https://github.com/arduino/app-bricks-py/tree/main/src/arduino/app_bricks/vlm) |
