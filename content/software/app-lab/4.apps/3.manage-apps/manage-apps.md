---
title: Manage Apps in Arduino App Lab
description: Learn how to create, duplicate, rename, import, export, and delete Apps using the Arduino App Lab interface.
overwriteSidebar: Manage Apps
tags:
  - Getting Started
  - Apps
  - Arduino App Lab
