...
- __PLCIn.Shared_Variable__: Conversely, this variable refers to the data that is being sent to the PLC from the Arduino sketch layer, recevied from Arduino IoT Cloud platform.
