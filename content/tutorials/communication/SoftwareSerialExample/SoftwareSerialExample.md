...
- **Newer Arduino boards**: Such as the UNO R4, Nano ESP32, MKR family, GIGA R1, Portenta, and Nano 33 BLE already include extra hardware serial ports (`Serial1`, `Serial2`, …). On those boards it is better to use the hardware ports directly instead of `SoftwareSerial`.
