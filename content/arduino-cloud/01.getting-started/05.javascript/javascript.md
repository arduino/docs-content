...
Next step is to create some cloud variables, which we will later interact with in our JavaScript code.
...
This example simply sends an update to the Arduino Cloud (updating the value of `test_value` to `20`), and awaits any changes from the cloud. 
